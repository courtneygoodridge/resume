...
A collaborative project between the School of Psychology and Institute for Transport Studies at the University of Leeds. My research aims to generate a better understanding of how drivers process visual information and initiate sensorimotor control whilst operating ground vehicles. This research will feed-forward into real-world applications to inform research, design and policy within the automotive industry.
...
During my undergraduate training, I established a key focus on quantitative research methods and design. Reports and essays have allowed me to develop a professional written manner and the ability to break down and synthesize complex academic literature in order to understand it and evaluate it's use in a given context.
...
- Seminar leader for first year undergraduate research skills and statistics module | *Skills: research design, scientific communication, quantitative data analysis* 

Teaching first and second year psychology students has allowed me to enhance my research skills by improving my overall knowledge base surrounding an area in order to teach this to others. This also demonstrates how I am able to confidently present complex ideas independently. Consequently, my science communication have vastly improved due to this position. 
...
- EEG signal preprocessing | *Skills: bandpass filtering, Independent Component Analysis, downsampling*
- EEG inferential analysis | *Head model construction, beamforming analysis*
...
This involved EEG signal processing (bandpass filtering, independent component analysis (ICA) and downsampling), head model construction from anatomical MRI scans and running beamformer analysis to spatially localise alpha power modulation sources within the occipital and somatosensory cortices. This manuscript was written up for target journal submission in NeuroImage.
...
Baldassi, G., Prpic, V., Goodridge, C., Agostini, T., Fantoni, C., & Soranzo, A (2016). Does the dimensionality of the perceived size play a role in the SNARC-like effect for visual illusions? (Conference abstract at the Proceedings of the Trieste Symposium on Perception and Cognition 2016).
